...
let apiInstance = new ToDoAndTracker.UserApi();
let body = new ToDoAndTracker.User(); // User | Created user object
...
let apiInstance = new ToDoAndTracker.UserApi();
let body = [new ToDoAndTracker.User()]; // [User] | List of user object
...
let apiInstance = new ToDoAndTracker.UserApi();
let body = new ToDoAndTracker.User(); // User | Updated user object
